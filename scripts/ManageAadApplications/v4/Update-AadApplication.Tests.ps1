...
Describe 'Update-AadApplication' {
    ...
    #         $result = Update-AadApplication -ObjectId $app1.Id -IdentifierUri "https://dev.panikbutton.eu/AzureAdApplicationManagementTestApp1"

    #         $result | Should -BeNullOrEmpty -Not
    #         $result.Application | Should -BeNullOrEmpty -Not
    #         $result.Application.IdentifierUris | Should -Be "https://dev.panikbutton.eu/AzureAdApplicationManagementTestApp1"
    #     }
    ...
    Context "Oauth2AllowImplicitFlow" {
        ...
        It "Given Oauth2AllowImplicitFlow should update value" {
            $result = Update-AadApplication -ObjectId $app1.Id -Oauth2AllowImplicitFlow $true
        ...
        It "Given new Oauth2AllowImplicitFlow should update old Oauth2AllowImplicitFlow value" {
            $result = Update-AadApplication -ObjectId $app1.Id -Oauth2AllowImplicitFlow $true
            $result = Update-AadApplication -ObjectId $app1.Id -Oauth2AllowImplicitFlow $false
